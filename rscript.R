# covid 19 football, by hhsievertsen@gmail.com, 13-6-2020
...
# Ridges
a<-dfp%>%filter(covid19==1)
b<-dfp%>%filter(covid19==00)
...
annotate_figure(fig,
                ...
                bottom = text_grob("Data sources: www.football-data.co.uk & football-data.org. By hhsievertsen - github.com/hhsievertsen/homecrowd. Ver: June 13,2020.", color = "grey",
